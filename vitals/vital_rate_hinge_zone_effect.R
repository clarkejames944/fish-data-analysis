...
g_z1z_1 <- function(z1, z0, u, a, is_m, m_par) {
  with(m_par, {
    # intercept
    IN = alpha + d_alpha_male * is_m + d_alpha_EBS * is_EBS + d_alpha_ETAS * is_ETAS + d_alpha_WTAS * is_WTAS  + u + u_year
    # threshold
    TR = eta + d_eta_male * is_m + d_eta_EBS * is_EBS + d_eta_ETAS * is_ETAS + d_eta_WTAS * is_WTAS
    # pre-threshold slope
    B1 = beta_1 + d_beta_1_male * is_m + d_beta_1_EBS * is_EBS + d_beta_1_ETAS * is_ETAS + d_beta_1_WTAS * is_WTAS
...
g_z1z_2 <- function(z1, z0, u, a, is_m, m_par) {
  with(m_par, {
    ...
    B2 = beta_2 + d_beta_2_male * is_m + d_beta_2_EBS * is_EBS + d_beta_2_ETAS * is_ETAS + d_beta_2_WTAS * is_WTAS
    # expected otolith size next year
